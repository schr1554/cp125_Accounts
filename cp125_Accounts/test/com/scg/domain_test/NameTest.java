...
public class NameTest {
	...
	public void nameConstructorNoParamsTest() {
		Name name = new Name();
		String nullValue = "null,null null";
		assertEquals(nullValue, name.toString());
	}

	@Test
	public void nameConstructorTwoParamsTest() {
		Name name = new Name("Test_Last", "Test_First");
		String nameValue = "Test_Last,Test_First NMN";
		assertEquals(nameValue, name.toString());
	}

	@Test
	public void nameConstructorThreeParamsTest() {
		Name name = new Name("Test_Last", "Test_First", "Test_Middle");
		String nameValue = "Test_Last,Test_First Test_Middle";
		assertEquals(nameValue, name.toString());
	}
	...
	public void hashCodeTest() {
		...
		strb.append("Test_First");
		strb.append("Test_Middle");
		strb.append("Test_Last");

		int hash = strb.toString().hashCode();
