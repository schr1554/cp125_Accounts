...
public class ConsultantTimeTest {
	...
	Account account = new ClientAccount("Acme Industries", new Name("Coyote", "Wiley"));
	...
	public void setAccountTest() {
		...
		ConsultantTime cTime = new ConsultantTime(date, account, skillType, hours);
		cTime.setAccount(new ClientAccount("Test Industries", new Name("Test", "Wiley")));
		assertEquals(new ClientAccount("Test Industries", new Name("Test", "Wiley")).getName(),
	...
	public void hashCodeTest() {
		ConsultantTime cTime = new ConsultantTime(date, account, skillType, hours);
		assertEquals(0, cTime.hashCode());
	}

	@Test
	public void equals() {
		ConsultantTime cTime = new ConsultantTime(date, account, skillType, hours);
		assertEquals(true, cTime.equals(account));
	}
